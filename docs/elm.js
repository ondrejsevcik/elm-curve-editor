...
var $author$project$RoastCurve$newFromDuration = function (duration) {
	var initialValues = _List_fromArray(
		[
			...
			{temperature: 380.0, time: duration * 0.15},
...
var $author$project$Main$margin = 50.0;
var $author$project$Main$aspectRatio = 9.0 / 16.0;
var $author$project$Main$outerWidth = 960.0;
var $author$project$Main$outerHeight = $author$project$Main$outerWidth * $author$project$Main$aspectRatio;
var $author$project$Main$innerHeight = $author$project$Main$outerHeight - ($author$project$Main$margin * 2.0);
var $author$project$Main$innerWidth = $author$project$Main$outerWidth - ($author$project$Main$margin * 2.0);
...
var $author$project$Main$getScales = function (curveValues) {
	var yScale = A2(
...
var $author$project$RoastCurve$getNewId = function (_v0) {
	...
	var lastId = A2(
		$elm$core$Debug$log,
		'size',
		$elm$core$Dict$size(curveValues) - 1);
	var lastValue = A2($elm$core$Dict$get, lastId, curveValues);
	if (lastValue.$ === 'Just') {
		var value = lastValue.a.a;
		return value.id + 1;
	} else {
		return 1;
	}
	...
	function (msg, model) {
		switch (msg.$) {
			case 'UpdateMousePosition':
				...
				var updatedCurveValues = function () {
					var _v1 = _Utils_Tuple2(model.mousePosition, model.activeValue);
					if ((_v1.a.$ === 'Just') && (_v1.b.$ === 'Dragging')) {
						var cx = _v1.a.a.cx;
						var cy = _v1.a.a.cy;
						var value = _v1.b.a;
						var _v2 = $author$project$Main$getScales(model.curveValues);
						var timeScale = _v2.a;
						var valueScale = _v2.b;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{curveValues: updatedCurveValues, mousePosition: newMousePosition}),
					$elm$core$Platform$Cmd$none);
			case 'AddAdjustPoint':
				var _v3 = model.mousePosition;
				if (_v3.$ === 'Just') {
					var cx = _v3.a.cx;
					var cy = _v3.a.cy;
					var _v4 = $author$project$Main$getScales(model.curveValues);
					var timeScale = _v4.a;
					var valueScale = _v4.b;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								activeValue: $author$project$Main$Selected(newValue),
			...
			case 'SelectAdjustPoint':
				var value = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeValue: $author$project$Main$Dragging(value)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DeselectSelectedAdjustPoint':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{activeValue: $author$project$Main$NoValue}),
					$elm$core$Platform$Cmd$none);
			case 'DragStartAdjustPoint':
				var value = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					$elm$core$Platform$Cmd$none);
			case 'StopDraggingAdjustPoint':
				var value = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeValue: $author$project$Main$Selected(value)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				...
				if (_v6.$ === 'Selected') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{activeValue: $author$project$Main$NoValue, curveValues: updatedCurveValues}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$DeleteSelectedValue = {$: 'DeleteSelectedValue'};
...
var $author$project$Main$AddAdjustPoint = {$: 'AddAdjustPoint'};
var $elm_community$typed_svg$TypedSvg$Types$Align = F2(
	function (a, b) {
		return {$: 'Align', a: a, b: b};
	});
var $author$project$Main$DeselectSelectedAdjustPoint = {$: 'DeselectSelectedAdjustPoint'};
...
var $author$project$Main$onDoubleClick = function (message) {
	return A2(
...
var $author$project$Main$decodeMousePosition = $elm$json$Json$Decode$maybe(
	A3(
		...
		A2(
			...
			_List_fromArray(
				['detail', 'y']),
			$elm$json$Json$Decode$float)));
var $author$project$Main$onSvgMouseMove = function (message) {
	return A2(
		$elm$svg$Svg$Events$on,
		'mouseMoveWithCoordinates',
		A2($elm$json$Json$Decode$map, message, $author$project$Main$decodeMousePosition));
};
...
var $author$project$Main$transparentColor = $avh4$elm_color$Color$fromRgba(
	{alpha: 0.0, blue: 0.0, green: 0.0, red: 0.0});
var $author$project$Main$SelectAdjustPoint = function (a) {
	return {$: 'SelectAdjustPoint', a: a};
};
var $author$project$Main$StopDraggingAdjustPoint = function (a) {
	return {$: 'StopDraggingAdjustPoint', a: a};
};
...
var $author$project$Main$viewAdjustPoints = F2(
	function (activeValue, svgPoints) {
		var circles = A2(
			$elm$core$List$map,
			function (_v0) {
				var value = _v0.a;
				var _v1 = _v0.b;
				var coordinateX = _v1.a;
				var coordinateY = _v1.b;
				var isSelected = _Utils_eq(
					activeValue,
					$author$project$Main$Selected(value)) || _Utils_eq(
					activeValue,
					$author$project$Main$Dragging(value));
				return A2(
					$elm_community$typed_svg$TypedSvg$circle,
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Attributes$cx(
							$elm_community$typed_svg$TypedSvg$Types$px(coordinateX)),
							$elm_community$typed_svg$TypedSvg$Attributes$cy(
							$elm_community$typed_svg$TypedSvg$Types$px(coordinateY)),
							$elm_community$typed_svg$TypedSvg$Attributes$r(
							$elm_community$typed_svg$TypedSvg$Types$px(5)),
							$elm_community$typed_svg$TypedSvg$Attributes$style('pointer-events: all'),
							$elm_community$typed_svg$TypedSvg$Attributes$stroke($avh4$elm_color$Color$blue),
							$elm_community$typed_svg$TypedSvg$Attributes$strokeWidth(
							$elm_community$typed_svg$TypedSvg$Types$px(2)),
							$elm_community$typed_svg$TypedSvg$Attributes$fill(
							isSelected ? $elm_community$typed_svg$TypedSvg$Types$Fill($avh4$elm_color$Color$green) : $elm_community$typed_svg$TypedSvg$Types$Fill($avh4$elm_color$Color$white)),
							$elm_community$typed_svg$TypedSvg$Events$onMouseDown(
							$author$project$Main$SelectAdjustPoint(value)),
							$elm_community$typed_svg$TypedSvg$Events$onMouseUp(
							$author$project$Main$StopDraggingAdjustPoint(value)),
							$author$project$Main$onSvgMouseMove($author$project$Main$UpdateMousePosition)
						]),
					_List_Nil);
			},
			svgPoints);
		return A2($elm_community$typed_svg$TypedSvg$g, _List_Nil, circles);
	});
...
var $author$project$Main$viewHoverLines = function (mousePosition) {
	if (mousePosition.$ === 'Nothing') {
		return $elm$html$Html$text('');
	} else {
		var position = mousePosition.a;
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm_community$typed_svg$TypedSvg$Types$px($author$project$Main$innerWidth)),
							$elm_community$typed_svg$TypedSvg$Attributes$y1(
							$elm_community$typed_svg$TypedSvg$Types$px(position.cy)),
							$elm_community$typed_svg$TypedSvg$Attributes$y2(
							$elm_community$typed_svg$TypedSvg$Types$px(position.cy)),
							$elm_community$typed_svg$TypedSvg$Attributes$style('pointer-events: none'),
							$elm_community$typed_svg$TypedSvg$Attributes$strokeWidth(
							$elm_community$typed_svg$TypedSvg$Types$px(2)),
							...
							$elm_community$typed_svg$TypedSvg$Types$Opacity(0.1))
						]),
					_List_Nil),
					A2(
					$elm_community$typed_svg$TypedSvg$line,
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Attributes$x1(
							$elm_community$typed_svg$TypedSvg$Types$px(position.cx)),
							$elm_community$typed_svg$TypedSvg$Attributes$x2(
							$elm_community$typed_svg$TypedSvg$Types$px(position.cx)),
							$elm_community$typed_svg$TypedSvg$Attributes$y1(
							$elm_community$typed_svg$TypedSvg$Types$px(0)),
							$elm_community$typed_svg$TypedSvg$Attributes$y2(
							$elm_community$typed_svg$TypedSvg$Types$px($author$project$Main$innerHeight)),
							$elm_community$typed_svg$TypedSvg$Attributes$style('pointer-events: none'),
							$elm_community$typed_svg$TypedSvg$Attributes$strokeWidth(
							$elm_community$typed_svg$TypedSvg$Types$px(2)),
							$elm_community$typed_svg$TypedSvg$Attributes$stroke($avh4$elm_color$Color$black),
...
var $folkertdev$one_true_path_experiment$Curve$catmullRomDistance = F3(
	function (alpha, p1, p2) {
		var l23_2a = A2(
			$elm$core$Basics$pow,
			$ianmackenzie$elm_geometry$Vector2d$squaredLength(
				A2($ianmackenzie$elm_geometry$Vector2d$difference, p1, p2)),
			alpha);
		return _Utils_Tuple2(
	...
	function (alpha, p0, p1, p2, p3) {
		return A2(
			...
			A5(
				...
				$ianmackenzie$elm_geometry$Vector2d$fromComponents(p1),
				$ianmackenzie$elm_geometry$Vector2d$fromComponents(p2),
				$ianmackenzie$elm_geometry$Vector2d$fromComponents(p3)));
	});
...
var $gampleman$elm_visualization$Shape$catmullRomCurve = function (alpha) {
	return $folkertdev$one_true_path_experiment$Curve$catmullRom(
...
var $author$project$Main$viewPath = function (svgPoints) {
	var linePath = A2(
		$gampleman$elm_visualization$Shape$catmullRomCurve,
		0.4,
		A2($elm$core$List$map, $elm$core$Tuple$second, svgPoints));
	return A2(
...
var $author$project$Main$viewSvg = function (model) {
	var _v0 = $author$project$Main$getScales(model.curveValues);
	var timeScale = _v0.a;
	var temperatureScale = _v0.b;
	var svgPoints = A2(
		$elm$core$List$map,
		function (v) {
			return _Utils_Tuple2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm_community$typed_svg$TypedSvg$Attributes$style('max-width:900px'),
				A2(
				$elm_community$typed_svg$TypedSvg$Attributes$preserveAspectRatio,
				A2($elm_community$typed_svg$TypedSvg$Types$Align, $elm_community$typed_svg$TypedSvg$Types$ScaleMid, $elm_community$typed_svg$TypedSvg$Types$ScaleMin),
				$elm_community$typed_svg$TypedSvg$Types$Slice),
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Main$outerWidth, $author$project$Main$outerHeight)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Main$margin, $author$project$Main$margin)
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Attributes$style('pointer-events: all;'),
										$elm_community$typed_svg$TypedSvg$Attributes$InPx$width($author$project$Main$innerWidth),
										$elm_community$typed_svg$TypedSvg$Attributes$InPx$height($author$project$Main$innerHeight),
										$elm_community$typed_svg$TypedSvg$Attributes$fill(
										$elm_community$typed_svg$TypedSvg$Types$Fill($author$project$Main$transparentColor)),
										$author$project$Main$onSvgMouseMove($author$project$Main$UpdateMousePosition),
										$elm_community$typed_svg$TypedSvg$Events$onMouseLeave(
										$author$project$Main$UpdateMousePosition($elm$core$Maybe$Nothing)),
										$author$project$Main$onDoubleClick($author$project$Main$AddAdjustPoint),
										$elm_community$typed_svg$TypedSvg$Events$onClick($author$project$Main$DeselectSelectedAdjustPoint)
									]),
								_List_Nil),
								A2(
								$elm_community$typed_svg$TypedSvg$g,
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm_community$typed_svg$TypedSvg$Types$Translate, 0, $author$project$Main$innerHeight)
											]))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm_community$typed_svg$TypedSvg$Types$Translate, 0, 0)
											]))
									]),
								_List_fromArray(
									[
								...
								$author$project$Main$viewHoverLines(model.mousePosition),
								$author$project$Main$viewPath(svgPoints),
								A2($author$project$Main$viewAdjustPoints, model.activeValue, svgPoints)
							]))
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$DeleteSelectedValue),
								$elm$html$Html$Attributes$disabled(
								_Utils_eq(model.activeValue, $author$project$Main$NoValue))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Attributes$style('margin-left: 1rem')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Tip: double click to add new point')
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$style('max-width:48rem; background:beige; padding:1rem;')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
